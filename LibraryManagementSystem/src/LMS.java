...
public class LMS extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == addButton) {
            ...
            String bookId = JOptionPane.showInputDialog("Enter ID of the Book to Edit");
            for (int i = 0; i < books.size(); i++) {
                if (books.get(i)[0].equals(bookId)) {
                    books.get(i)[1] = textField2.getText();
                    books.get(i)[2] = textField3.getText();
                    books.get(i)[3] = textField4.getText();
                    books.get(i)[4] = textField5.getText();
                    books.get(i)[5] = textField6.getText();
                    books.get(i)[6] = textField7.getText();
            ...
            String bookId = JOptionPane.showInputDialog("Enter ID of the Book to Delete");
            for (int i = 0; i < books.size(); i++) {
                if (books.get(i)[0].equals(bookId)) {
                    books.remove(i);
